...
export function DrillingClient({
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-0 pb-24 md:pb-10">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 rounded-2xl p-4 md:p-5 mt-3 md:mt-0 mb-4 shadow-xl border border-slate-700 flex items-center justify-between gap-3">
        {/* Decorative blobs */}
...
function SummaryBar({
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 rounded-2xl p-3.5 flex flex-col gap-2.5 md:flex-row md:items-center md:justify-between">
      <div className="pointer-events-none absolute -top-10 -right-8 w-28 h-28 rounded-full bg-blue-500/25 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-12 -left-8 w-28 h-28 rounded-full bg-amber-400/15 blur-3xl" />
