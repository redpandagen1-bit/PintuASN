  ...
  return (
    <>
      ...
      <div className="hidden md:block space-y-5 pb-10">
        ...
        {/* Statistik Belajar — surface putih (bukan gradient navy) supaya beda dari
            kartu promo/upgrade yang juga navy; data statistik pribadi & iklan upgrade
            jadi gak kebaca sama beratnya lagi. */}
        <section className="bg-white rounded-3xl p-5 md:p-7 shadow-sm border border-slate-100 space-y-5">
          <div className="flex flex-row items-center justify-between gap-3">
            <div>
              ...
              <p className="text-slate-500 text-xs mt-0.5">Pantau perkembangan belajarmu.</p>
            </div>
