      ...
      <main className="flex-1 p-6 md:p-10">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6">
          ...
          <div className="flex items-center gap-3 bg-white p-2 rounded-2xl border border-slate-200 shadow-sm">
            <Link
              href="/dashboard"
              className="flex items-center gap-2 px-5 py-2.5 text-slate-500 rounded-xl text-sm font-bold hover:bg-slate-50 transition-colors"
            >
              <ArrowLeft size={16} />
              Dashboard
            </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-10">
          ...
          {/* Left hero */}
          <section className="lg:col-span-8 bg-slate-800 rounded-[2.5rem] p-10 shadow-2xl shadow-slate-200 relative overflow-hidden text-white">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="relative flex-shrink-0">
                <div className="w-48 h-48 rounded-full border-[12px] border-slate-700 flex items-center justify-center relative shadow-inner">
                  <svg className="absolute w-full h-full -rotate-90">
                    <circle cx="96" cy="96" r="84" stroke="currentColor" strokeWidth="12" fill="transparent" className="text-yellow-400/20" />
                    <circle
                      cx="96" cy="96" r="84" stroke="currentColor" strokeWidth="12" fill="transparent"
                      strokeDasharray="527"
                      strokeDashoffset={527 - 527 * (finalScore / 550)}
                      className="text-yellow-400 drop-shadow-[0_0_8px_rgba(250,204,21,0.5)]"
                      strokeLinecap="round"
                    />
                  </svg>
                  <div className="text-center">
                    <span className="block text-5xl font-black text-white">{finalScore}</span>
                    <span className="text-[10px] font-black text-yellow-400 tracking-[0.2em] uppercase">Skor Total</span>
                  </div>
                </div>
              </div>
          ...
          {/* Right: 3 score cards in ONE horizontal row inside a single container */}
          <section className="lg:col-span-4 flex flex-col justify-between gap-4">
            ...
            {/* Quick stats below score cards */}
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-sm">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Peringkat</p>
                <p className="text-2xl font-black text-slate-800">#{packageRank}</p>
                <p className="text-[10px] text-slate-400">dari {totalParticipants} peserta</p>
              </div>
              <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-sm">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Persentil</p>
                <p className="text-2xl font-black text-yellow-500">{percentile}%</p>
                <p className="text-[10px] text-slate-400">lebih baik</p>
              </div>
            </div>
          </section>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
                ...
                <div className="h-[280px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={chartData}>
                      ...
                      <Line type="monotone" dataKey="TKP" stroke="#94A3B8" strokeWidth={2} strokeDasharray="5 5" dot={false} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </section>
            ...
            {/* Leaderboard + Time Analysis grid */}
            ...
            {lastThreeAttempts.length > 0 && (
              <section className="bg-white rounded-[2.5rem] p-8 border border-slate-200 shadow-sm overflow-x-auto">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            {/* Ranking card */}
            <section className="bg-white rounded-[2.5rem] p-8 border border-slate-200 shadow-sm text-center">
              <h3 className="font-black text-slate-800 mb-8 uppercase tracking-widest text-xs">Peringkat Kamu</h3>
            ...
            {/* Questions detail */}
            {answers.length > 0 && (
              <section className="bg-slate-800 rounded-[2.5rem] p-8 border border-slate-700 shadow-xl overflow-hidden relative">
                ...
                <div className="space-y-3 relative z-10 max-h-[360px] overflow-y-auto pr-2" style={{ scrollbarWidth: 'thin', scrollbarColor: '#475569 transparent' }}>
