...
import { Lock, TrendingUp, Search, X, FileText,
...
function PackageCard({
  ...
  return (
    <div className="relative bg-white rounded-2xl border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all duration-200 flex flex-col">
    ...
    <>
      <div className="space-y-5 pb-10">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <p className="text-slate-500 text-sm">
                Menampilkan <span className="font-medium text-slate-700">{filtered.length}</span>{' '}
                dari <span className="font-medium text-slate-700">{packages.length}</span> paket.
              </p>
        ...
        {filtered.length > 0 ? (
          ...
          <div className="bg-white rounded-3xl p-12 shadow-sm border border-slate-100 flex flex-col items-center text-center">
